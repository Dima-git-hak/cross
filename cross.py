...
class TicTacToe:
    ...
    def start(self):
        ...
        while True:
            ...
            if self.validate():
                print(f"{G}player{self.player}{G} выигрывает.{N}",
                      ' '*10)
            ...
            print(f"{N}Player{self.player}{N}\очередь")
    ...
    def playermove(self):
        ...
        while True:
            ...
            try:
                ...
                print(f"{R}Введите допустимую позицию.{N}",
                      end="\r")
